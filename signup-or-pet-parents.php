...
<head>
    ...
    <meta name="keyword" content="Love And Paws" />

    <!--  Title -->
    <title>Love And Paws</title>
...
<body class="v-light hamburger-menu dsn-effect-scroll dsn-ajax" data-dsn-mousemove="true">
    ...
    <div class="preloader">
        ...
        <div class="preloader-block">
            <div class="title">Love And Paws</div>
    ...
    <main class="main-root">
        <div id="dsn-scrollbar">
            ...
            <div class="wrapper">
                <header class="back-top-cont" style="background-image: url('assets/img/home/sign-up-1-banner.png');">
                    ...
                    <div class="container section-margin">
                        ...
                        <div class="row mar-bottom-25">
                            <div class="col-md-6 col-6">
                                <h3 class="text-right text-active"><a href="signup-or-pet-parents.php">For Pet Parents</a></h3>
                            </div>
                            <div class="col-md-6 col-6">
                                <h3 class="text-none-active"><a href="signup-for-professionals.php">For Professionals</a></h3>
                            </div>
                        </div>
                        ...
                        <div class="row dis-flex-center">
                            <div class="col-lg-6">
                                <div class="box-info-contact-2">
                                    <img src="assets/img/home/sign-up-1.png" alt="">
                                </div>
                            </div>
