...
!(function (e) {
  ...
  var o,
    ...
    D = {
      ...
      scriptpath:
        ((t =
          R.currentScript ||
          (!!(o = R.getElementsByTagName("script")).length && o[o.length - 1])),
        (r = t ? t.src.split("?")[0] : ""),
        0 < r.split("/").length
    ...
    l = function (e, o) {
      ...
      function l(e, o, t, r) {
        ...
        if (o) {
          if (
            ...
            if (x.nativeparentscrolling && t && !b.ispage && !b.zoomactive)
              return !0;
            var n = b.view.h >> 1;
            b.newscrolly < -n
              ? ((b.newscrolly = -n), (o = -1))
              : b.newscrolly > b.page.maxh + n
              ? ((b.newscrolly = b.page.maxh + n), (o = 1))
              : (o = 0);
          }
          var l = 0 < o ? 1 : -1;
          g !== l &&
      ...
      function i(e, o, t) {
        ...
        else if (((k = !1), e.stopImmediatePropagation(), e.preventDefault))
      ...
      if (
        ...
        var a = this.win[0] == _ ? this.body : this.win,
          c =
            a.css("writing-mode") ||
            a.css("-webkit-writing-mode") ||
            a.css("-ms-writing-mode") ||
            a.css("-moz-writing-mode");
        "horizontal-tb" == c || "lr-tb" == c || "" === c
          ? ((this.isrtlmode = "rtl" == a.css("direction")),
            (this.isvertical = !1))
          : ((this.isrtlmode =
      ...
      (this.rail = !1),
        ...
        (this.detected = (function () {
          ...
          return (
            ...
            (n.cantouch =
              "ontouchstart" in R.documentElement || "ontouchstart" in _),
            (n.hasw3ctouch =
              !!_.PointerEvent &&
      ...
      (this.getDocumentScrollOffset = function () {
        ...
        (this.updateScrollBar = function (e) {
          ...
          if (b.ishwscroll)
            ...
            if (
              ...
              }).top += n(b.win, "border-top-width", !0)),
              (o.left += b.rail.align
                ? b.win.outerWidth() -
                  n(b.win, "border-right-width") -
                  b.rail.width
                : n(b.win, "border-left-width")),
              (t = x.railoffset) &&
              ...
              var i = b.railh.align
                  ? o.top +
                    n(b.win, "border-top-width", !0) +
                    b.win.innerHeight() -
                    b.railh.height
                  : o.top + n(b.win, "border-top-width", !0),
        ...
        (this.init = function () {
          ...
          (x.emulatetouch = x.emulatetouch || x.touchbehavior),
            (b.hasborderbox =
              _.getComputedStyle &&
              "border-box" === _.getComputedStyle(R.body)["box-sizing"]);
          ...
          if (
            ...
            b.ishwscroll &&
              ...
              S.transitionend &&
                b.bind(b.doc, S.transitionend, b.onScrollTransitionEnd, !1)),
            (b.zindex = "auto"),
            ...
            for (var l in n)
              (s = n[l]),
                (i = x.railpadding[s] || 0) && r.css("padding-" + s, i + "px");
            r.append(o),
            ...
            if (
              ...
              if (b.ishwscroll) {
                ...
                b.isfixed || (b.viewport = b.getViewport(b.win[0])),
                  b.viewport &&
                    ((b.body = b.viewport),
                    /fixed|absolute/.test(b.viewport.css("position")) ||
            ...
            if (
              (!1 === x.autohidemode
                ? ((b.autohidedom = !1),
                  ...
                  b.railh && b.railh.css({ opacity: x.cursoropacitymax }))
              ...
              (b.ontouchstart = function (e) {
                ...
                if (
                  ...
                  if (
                    ...
                    /SUBMIT|CANCEL|BUTTON/i.test(P(o).attr("type")) &&
                ...
                if (2 == b.rail.drag.pt) {
                  ...
                  if (b.ishwscroll && x.bouncescroll)
                    c < 0
                      ? (c = Math.round(c / 2))
                      : c > b.page.maxh &&
                        (c = b.page.maxh + Math.round((c - b.page.maxh) / 2));
                  else if (
                    (c < 0
                      ? (s = c = 0)
                      : c > b.page.maxh && ((c = b.page.maxh), (s = 0)),
                    0 === s && !b.hasmoving)
                  )
                  ...
                  if (
                    (b.railh &&
                      ...
                      b.ishwscroll && x.bouncescroll
                        ? d < 0
                          ...
                          : d > b.page.maxw &&
                            (d =
                              b.page.maxw + Math.round((d - b.page.maxw) / 2))
                        : (d < 0 && (l = d = 0),
                          d > b.page.maxw && ((d = b.page.maxw), (l = 0)))),
                    !b.hasmoving)
                  ) {
                    if (
                    ...
                    if (
                      ...
                      return b.cancelEvent(e);
                    b.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0),
                      (b.hasmoving = !0);
                  }
                  return (
                    b.preventclick &&
                    ...
                    b.rail.drag.dl &&
                      ("v" == b.rail.drag.dl
                        ? (d = b.rail.drag.sl)
                        : "h" == b.rail.drag.dl && (c = b.rail.drag.st)),
                    b.synched("touchmove", function () {
                      b.rail.drag &&
                        ...
                        b.railh && b.railh.scrollable
                          ? (b.setScrollLeft(d), b.showCursor(c, d))
                          : b.showCursor(c),
            ...
            if (
              ...
              (b.onmousemove = function (e) {
                if (b.rail.drag) {
                  ...
                  if (
                    ...
                    (b.scroll.y = b.rail.drag.sy + (e.clientY - b.rail.drag.y)),
                      b.scroll.y < 0 && (b.scroll.y = 0);
                    var t = b.scrollvaluemax;
                    b.scroll.y > t && (b.scroll.y = t);
                  }
              ...
              (b.onpreventclick = function (e) {
                ...
                (b.onclick =
                  ...
                  function (e) {
                    return (
                      !b.lastmouseup || ((b.lastmouseup = !1), b.cancelEvent(e))
                    );
                  }),
                x.grabcursorenabled &&
                  S.cursorgrabvalue &&
            ...
            if (
              (S.hasw3ctouch
                ...
                : S.cantouch &&
                  ...
                  b.delegate(R, "touchmove", b.ontouchmove, !1, !0)),
              x.emulatetouch &&
              ...
              x.enablemousewheel &&
                (b.isiframe ||
                  b.mousewheel(S.isie && b.ispage ? R : b.win, b.onmousewheel),
              ...
              (b.onkeypress = function (e) {
                ...
                if (
                  ...
                  switch (t) {
                    ...
                    case 63232:
                      b.railh &&
                        (r ? b.doScrollLeft(0) : b.doScrollLeftBy(72),
                        (s = !0));
                      break;
                    case 39:
                    case 63234:
                    ...
                    case 36:
                    case 63273:
                      b.railh && r ? b.doScrollPos(0, 0) : b.doScrollTo(0),
                        (s = !0);
                      break;
                    case 35:
                    case 63275:
                    ...
                    case 32:
                      x.spacebarenabled &&
                        (i ? b.doScrollBy(b.view.h) : b.doScrollBy(-b.view.h),
                        (s = !0));
                      break;
                    case 27:
            ...
            if (
                    ...
                    if (
                      (e.forEach(function (e) {
                        if ("attributes" == e.type)
                          return y.hasClass("modal-open") &&
                            y.hasClass("modal-dialog") &&
                            !P.contains(P(".modal-dialog")[0], b.doc[0])
                            ? b.hide()
                            : b.show();
                      }),
              ...
              !1 !== B
                ...
                : (b.bind(
                  ...
                  S.isie9 &&
                    v.attachEvent("onpropertychange", b.onAttributeChange),
          ...
          if ("IFRAME" == this.doc[0].nodeName) {
            var w = function () {
              ...
              b.lazyResize(30),
                ...
                x.enablekeyboard &&
                  b.bind(o, S.isopera ? "keypress" : "keydown", b.onkeypress),
                S.cantouch
                  ...
                  : x.emulatetouch &&
                    ...
                    x.grabcursorenabled &&
                      S.cursorgrabvalue &&
                      b.css(P(o.body), { cursor: S.cursorgrabvalue })),
                b.bind(o, "mouseup", b.ontouchend),
                b.zoom &&
                  (x.dblclickzoom && b.bind(o, "dblclick", b.doZoom),
        ...
        (this.showCursor = function (e, o) {
          if (
            ...
            if (
              (b.autohidedom &&
                (b.autohidedom.stop().css({ opacity: x.cursoropacitymax }),
                (b.cursoractive = !0)),
              (b.rail.drag && 1 == b.rail.drag.pt) ||
                (void 0 !== e &&
                  !1 !== e &&
                  (b.scroll.y = (e / b.scrollratio.y) | 0),
                void 0 !== o && (b.scroll.x = (o / b.scrollratio.x) | 0)),
              ...
              ((b.hasmousefocus && "leave" === x.autohidemode) ||
                (b.cursortimeout = setTimeout(function () {
                  (b.rail.active && b.showonmouseevent) ||
                    (b.autohidedom
                      .stop()
                      .animate({ opacity: x.cursoropacitymin }),
                    b.zoom &&
                      b.zoom.stop().animate({ opacity: x.cursoropacitymin }),
                    (b.cursoractive = !1)),
                    (b.cursortimeout = 0);
                }, e || x.hidecursordelay))));
        }),
        ...
        (this.onResize = function (e, o) {
          ...
          return (
            0 === b.page.maxh
              ...
              : ((b.page.maxh -= x.railpadding.top + x.railpadding.bottom),
                (b.rail.scrollable = !0)),
            0 === b.page.maxw
              ? (b.hideRailHr(),
                (b.scrollvaluemaxw = 0),
              ...
              : ((b.page.maxw -= x.railpadding.left + x.railpadding.right),
            ...
            b.railslocked
              ...
              : (b.hidden ||
                ...
                b.hasborderbox ||
                  (b.scrollvaluemax -=
                    b.cursor[0].offsetHeight - b.cursor[0].clientHeight),
                b.railh &&
                  ((b.railh.width =
                ...
                b.getScrollTop() > b.page.maxh
                  ...
                  : ((b.scroll.y = (b.getScrollTop() / b.scrollratio.y) | 0),
                    (b.scroll.x = (b.getScrollLeft() / b.scrollratio.x) | 0),
      ...
      (this.delegate = function (e, o, t, r, i) {
          ...
          if (s && s.l)
            for (var n = 0, l = s.l.length; n < l; n++)
              s.a[n] === b.id &&
                (s.a.splice(n),
                s.l.splice(n),
                0 === s.a.length && (b._unbind(e, o, s.l.f), (O[o] = null)));
        }),
        ...
        (this.hideRailHr = function () {
          return (
            b.railh &&
              ((b.railh.visibility = !1), b.railh.css("display", "none")),
            b
          );
        }),
        (this.show = function () {
        ...
        (this.onmousewheelhr = function (e) {
          if (!b.wheelprevented) {
            ...
            return (
              ...
              (b.checkarea = o),
              !!b.nativescrollingarea ||
                (b.railslocked ? b.cancelEvent(e) : i(e, !0, t))
            );
          }
        }),
        (this.stop = function () {
          ...
          (this.resetTransition = function () {
            ...
            (this.prepareTransition = function (e, o) {
              ...
              return (
                T !== r &&
                  ((T = r),
                  b.doc.css(S.prefixstyle + "transition-duration", r)),
                t
              );
            }),
              ...
              if (
                ...
                x.bouncescroll
                  ? (o < 0
                      ? (o = (o / 2) | 0)
                      : o > b.page.maxh &&
                        (o = (b.page.maxh + (o - b.page.maxh) / 2) | 0),
                    e < 0
                      ? (e = (e / 2) | 0)
                      : e > b.page.maxw &&
                        (e = (b.page.maxw + (e - b.page.maxw) / 2) | 0))
            ...
            (this.doScrollPos = function (e, o, t) {
              ...
              if (
                ((b.bouncescroll && b.rail.visibility) ||
                  (o < 0
                    ? (s = !(o = 0))
                    : o > b.page.maxh && ((o = b.page.maxh), (s = !0))),
                (b.bouncescroll && b.railh.visibility) ||
                  (e < 0
                    ? (s = !(e = 0))
                    : e > b.page.maxw && ((e = b.page.maxw), (s = !0))),
              ...
              (b.bzscroll.x = new d(i, b.newscrollx, l, 0, 0, a, 1)),
                (b.bzscroll.y = new d(r, b.newscrolly, l, 0, 0, a, 1));
              X();
              var c = function () {
                if (b.scrollrunning) {
      ...
      (this.doScrollBy = function (e, o) {
        ...
        (b.onscroll = function (e) {
          b.rail.drag ||
            b.cursorfreezed ||
            b.synched("scroll", function () {
              (b.scroll.y = Math.round(b.getScrollTop() / b.scrollratio.y)),
                b.railh &&
        ...
        (this.doZoomIn = function (e) {
          if (!b.zoomactive) {
            ...
            (b.zoomrestore.style.width = b.win.css("width")),
              ...
              S.isios4 &&
                ((b.zoomrestore.scrollTop = I.scrollTop()), I.scrollTop(0)),
              b.win.css({
    ...
    q = function (e) {
      ...
      (this.nc = e),
        ...
        (this.doSnapy = function (e, o) {
          ...
          o < 0
            ? (t = !(o = 0))
            : o > f.nc.page.maxh && ((o = f.nc.page.maxh), (t = !0)),
            e < 0
              ? (t = !(e = 0))
              : e > f.nc.page.maxw && ((e = f.nc.page.maxw), (t = !0)),
            t
          ...
          if (a || c) {
            ...
            var h = f.lastscrollx,
              ...
              m = function () {
                ...
                f.speedx &&
                  ((h = Math.floor(f.lastscrollx - f.speedx * (1 - f.demulxy))),
                  ((f.lastscrollx = h) < 0 || n < h) && (e = 0.1)),
                  f.speedy &&
                    ((p = Math.floor(
                      f.lastscrolly - f.speedy * (1 - f.demulxy)
                    )),
                    ((f.lastscrolly = p) < 0 || s < p) && (e = 0.1)),
                  ...
                  f.demulxy < 1
                    ...
                    : (f.stop(), f.nc.hideCursor(), f.doSnapy(h, p));
              };
            m();
  ...
  (e.cssHooks.pageYOffset = {
    ...
    set: function (e, o) {
      ...
      return (
        t && t.ishwscroll ? t.setScrollTop(parseInt(o)) : i.call(e, o), this
      );
    },
  }),
  ...
  (P.cssHooks.pageXOffset = {
    ...
    set: function (e, o) {
      var t = P.data(e, "__nicescroll") || !1;
      return (
        t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : n.call(e, o), this
      );
    },
  }),
